...
export default function ABitMoreDetail() {
      ...
      <main className="flex-grow flex flex-col items-center justify-start pt-6 px-6">
        <div className="max-w-6xl w-full flex flex-col items-center gap-6">
          <div className="bg-white text-gray-900 rounded-md border border-gray-400 max-w-xl w-full p-6 leading-6 text-sm">
            <p>The <code className="text-gray-400 font-bold" style={{ letterSpacing: "-1.2px" }}>--</code> characters you entered caused the database to ignore the rest of the SQL statement, allowing you to be authenticated without having to supply the real password.</p>
          </div>

          <Link href="/lessons/sql-injection/finish">
            <span className="h-7 w-7 bg-gray-700 hover:bg-gray-800 text-white flex items-center justify-center rounded-full">
              ➤
            </span>
          </Link>
